  ...
  return (
      ...
      <Container element = {
        ...
        <div className="mt-[15vh] max-w-[35vw]">
              ...
              <a href="https://github.com/MohitMaulekhi"  target="_blank" rel="noreferrer" ><button className="mr-[1.5vw]"><FontAwesomeIcon icon={faSquareGithub} size="xl"/></button></a>
              <a href="https://mail.google.com/mail/?view=cm&to=mohitmaulekhi312@gmail.com" target="_blank" rel="noreferrer" ><button className="mr-[1.5vw]"><FontAwesomeIcon icon={faGoogle} size="xl" /></button></a>
              <a href="https://www.linkedin.com/in/mohit-maulekhi-222395267/" target="_blank" rel="noreferrer" ><button className="mr-[1.5vw]"><FontAwesomeIcon icon={faLinkedin} size="xl" /></button></a>
              <a href="https://www.instagram.com/mohit_maulekhi_/" target="_blank" rel="noreferrer" ><button className="mr-[1.5vw]"><FontAwesomeIcon icon={faInstagram} size="xl" /></button></a>
          </div>
